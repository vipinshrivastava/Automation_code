...
public class VentanaChat extends javax.swing.JFrame {
    ...
    private String leerIP() {
        return JOptionPane.showInputDialog(null, "Please Enter IP : ", "192.168.1.31");
    }

    private String leerNick() {
        return JOptionPane.showInputDialog(null, "Please Enter Your Name : ", "Ram");
    }
}
